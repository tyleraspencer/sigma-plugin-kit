...
export default function App() {
  ...
  // highlights one item. Comparing the raw value works by accident for a
  // single selection -- String(['Samsung']) === 'Samsung' -- and matches
  // nothing once there are two, since String(['A','B']) is 'A,B'.
  ...
  return (
    <div style={S.wrap}>
      <div style={S.top}>
        <div style={S.title}>Plugs Region Revenue</div>
